...
public class BestBuy9 {
	...
	public static void main(String[] args) {
		...
		dropdown.click();
		WebElement furniture = driver.findElement(By.xpath("//li[@class='liDropdownList '][6]"));
		furniture.click();
		driver.findElement(By.xpath("//a[text()='Luggage']")).click();
		driver.findElement(By.xpath("((//h4[@class='sku-title'])//a)[3]")).click();
		driver.findElement(By.xpath("(//div[@class='fulfillment-add-to-cart-button'])[1]")).click();
		//h4[@class='sku-title']//a[text()='Arcade1Up - Capcom Street Fighter II Legacy Stool - Multi']
		driver.navigate().back();
		//8th	//choose brand
		driver.navigate().back();
		...
		driver.findElement(By.xpath("//a[text()='Refurbished Samsung phones']")).click();
		
		driver.findElement(By.xpath("(//h4[@class='sku-title']//a)[8]")).click();
		driver.findElement(By.xpath("(//div[@class='fulfillment-add-to-cart-button'])[1]")).click();

		//a[text()='Samsung - Pre-Owned Galaxy Note20 Ultra 5G 128GB (Unlocked) - Mystic Black']
		//9th tc
	...
	/*	driver.findElement(By.xpath("//button[text()='Switch all to shipping']")).click();
		...
		*/
		driver.findElement(By.id("user.emailAddress")).sendKeys("sadhanasuba24@test.com");
		driver.findElement(By.id("user.phone")).sendKeys("9688741481");
